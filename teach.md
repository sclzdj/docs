...
> 学习不是对个别刺激做出个别反应，而是通过对一定情境中的各事物间关系的理解构成一种“完形”来实现的，是一种**顿悟**形式的智慧行为

### 小鸡啄米实验

> 苛勒

> 学习的迁移不是在于环境刺激的相同要素,而是环境**刺激各要素间的整体关系**，也是发生**顿悟**的结果
...
>（1）感知运算阶段（0-2岁），特点：主要认知结构是感知运动图式。
>
>（2）前运算阶段（2-7岁），特点：泛灵论、自我为中心、思维不可逆、缺乏守恒、缺乏层级类概念。
>
>（3）具体运算阶段（7-11岁），特点：守恒性、脱自我中心性、思维可逆性、具体事物支持的抽象概念。
>
>（4）形式运算阶段（11-16岁），特点：概念、命题、抽象逻辑思维、假设一演绎推理。
>
